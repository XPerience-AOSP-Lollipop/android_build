...
print("Repository for %s not found in the XPerience-AOSP-Lollipop Github repository list. If this is in error, you may need to manually add it to your local_manifests/roomservice.xml." % device)
